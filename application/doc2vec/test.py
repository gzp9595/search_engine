...
if __name__ == '__main__':
    ...
    print
    engine.get_similarity(embedding1=em0, embedding2=em01, mode=0)
    print
    engine.get_similarity(embedding1=em1, embedding2=em11, mode=1)
    print
    engine.get_similarity(embedding1=em2, embedding2=em21, mode=2)
    print
    engine.get_similarity(embedding1=em3, embedding2=em31, mode=3)
    print
    engine.get_similarity(embedding1=em4, embedding2=em41, mode=4)
